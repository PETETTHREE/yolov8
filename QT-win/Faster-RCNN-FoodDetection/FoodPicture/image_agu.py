...
class ImgAugemention():
    ...
    def shift_pic_bboxes(self, xml_path, img_path, img_save_path, save_path_xml):
        ...
        for xmls in os.listdir(xml_path):
            ...
            输入:
                img:图像array
                bboxes:该图像包含的所有boundingboxs,一个list,每个元素为[x_min, y_min, x_max, y_max,Annotations_agu_txt],要确保是数值
            输出:
...
if __name__ == '__main__':
    ...
    增强后的标签位置
    增强后的图片位置'''
    imgs_path = 'E:/code/p/xiao-study/QT-win/Faster-RCNN-FoodDetection/FoodPicture/Images/'
    xmls_path = 'E:/code/p/xiao-study/QT-win/Faster-RCNN-FoodDetection/FoodPicture/Annotations/'
    save_xml = 'E:/code/p/xiao-study/QT-win/Faster-RCNN-FoodDetection/FoodPicture/Images2/'
    save_img = 'E:/code/p/xiao-study/QT-win/Faster-RCNN-FoodDetection/FoodPicture/Annotations2/'
    print("start rorate!!!")
