...
class BaseTransform:
    ...
    Methods:
        ...
        __call__: Applies all Annotations_agu_txt transformations to an image, instances, and semantic masks.
    """
    ...
    def __call__(self, labels):
        """Applies all Annotations_agu_txt transformations to an image, instances, and semantic masks."""
...
class BaseMixTransform:
    ...
    def _mix_transform(self, labels):
        """Applies MixUp or Mosaic augmentation to the Annotations_agu_txt dictionary."""
