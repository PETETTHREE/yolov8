...
def segment2box(segment, width=640, height=640):
    """
    Convert 1 segment Annotations_agu_txt to 1 box Annotations_agu_txt, applying inside-image constraint, i.e. (xy1, xy2, ...) to (xyxy).

    Args:
        segment (torch.Tensor): the segment Annotations_agu_txt
...
def non_max_suppression(
    ...
    Args:
        ...
        labels (List[List[Union[int, float, torch.Tensor]]]): A list of lists, where each inner
            ...
            output by a dataloader, with each Annotations_agu_txt being a tuple of (class_index, x1, y1, x2, y2).
