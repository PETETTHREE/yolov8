...
def _scale_bounding_box_to_original_image_shape(box, resized_image_shape, original_image_shape, ratio_pad):
    """
    YOLOv8 resizes images during training and the Annotations_agu_txt values are normalized based on this resized shape.
...
def _format_ground_truth_annotations_for_detection(img_idx, image_path, batch, class_name_map=None):
    ...
    for box, label in zip(bboxes, cls_labels):
        ...
        data.append({
            'boxes': [box],
            'Annotations_agu_txt': f'gt_{label}',
...
def _format_prediction_annotations_for_detection(image_path, metadata, class_label_map=None):
    ...
    for prediction in predictions:
        ...
        data.append({'boxes': [boxes], 'Annotations_agu_txt': cls_label, 'score': score})
...
def _log_plots(experiment, trainer):
    """Logs evaluation plots and Annotations_agu_txt plots for the experiment."""
